...
and tracking-based impact metrics can explain what happened in basketball
...
+ \text{Residual}.
\]
The same structure holds for defense with \texttt{dEFG}, \texttt{dFT},
\texttt{dTOV}, and \texttt{dSC} after sign-flipping defensive factors so that
positive is good for the player's team.  The point of the paper is that the
residual is almost zero: the actual ORAPM and DRAPM coefficients decompose
nearly perfectly into these factors.
